...
- **Results folder**: intermediate result generated by each step are stored in the *results* folder, organized by step number.
- **ChatGPT parameter analysis**: all materials related to the analysis of ChatGPT parameters for services extraction are under the folder, along with a dedicated README.
