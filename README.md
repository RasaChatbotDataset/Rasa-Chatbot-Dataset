...
- **Result folders**: intermediate results generated by each step are stored in the *results* folder, organized by step number.
...
The intermediate original results of each step are available in folder *results*, so that results can be compared step by step.
